...
Vue.component("purple_header_component_1721891105", {
    template: `
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        <li><a id="Ethereum Explorer-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" :class="[textStylePrimary, hoverTextStylePrimary]" href="Ethereum Explorer.html">Ethereum Explorer</a></li>
                        <li><a id="Transaction Analysis-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Transaction Analysis.html" :class="[textStylePrimary, hoverTextStylePrimary]">Transaction Analysis</a></li>
                        <li><a id="Contract Monitoring-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Contract Monitoring.html" :class="[textStylePrimary, hoverTextStylePrimary]">Contract Monitoring</a></li>
                        <li><a id="Blockchain Data-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Blockchain Data.html" :class="[textStylePrimary, hoverTextStylePrimary]">Blockchain Data</a></li>
                        <li><a id="New Transaction Alerts-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="New Transaction Alerts.html" :class="[textStylePrimary, hoverTextStylePrimary]">New Transaction Alerts</a></li>
                    </ul>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5" :class="signUpButtonGradient">
                            ...
                            <li><a id="mobile-Transaction Analysis-link" class="flex font-medium text-sm py-1.5" href="Transaction Analysis.html" :class="[textStylePrimary,hoverTextStylePrimary]">Transaction Analysis</a></li>
                            <li><a id="mobile-Contract Monitoring-link" class="flex font-medium text-sm py-1.5" href="Contract Monitoring.html" :class="[textStylePrimary,hoverTextStylePrimary]">Contract Monitoring</a></li>
                            <li><a id="mobile-Blockchain Data-link" class="flex font-medium text-sm py-1.5" href="Blockchain Data.html" :class="[textStylePrimary,hoverTextStylePrimary]">Blockchain Data</a></li>
                            <li><a id="mobile-New Transaction Alerts-link" class="flex font-medium text-sm py-1.5" href="New Transaction Alerts.html" :class="[textStylePrimary,hoverTextStylePrimary]">New Transaction Alerts</a></li>
                        </ul>
                    </nav>
